...
public class RobotContainer {
    ...
    private void configureBindings() {
       ...
       // joystick.a().whileTrue(drivetrain.applyRequest(() -> brake));
        ...
        joystick.y().onTrue(drivetrain.applyRequest(() ->
    ...
    //Next lines were added from CTRE documentation to see sysids
 ...
 */
    ...
    //         drivetrain.applyRequest(() ->
    //         //Initially the velocity was 0.5 but was lowered  to 0.05
    //             drive.withVelocityX(5)
    //                 .withVelocityY(0)
    //                 .withRotationalRate(0)
    //         )
    //         //Initially this was at 5 second but was lowered to 1 second
    //         .withTimeout(5.0),
